...
namespace Vivastreet_DataAccess.Migrations
{
    ...
    [Migration("20220716073920_datalayerAdded1")]
    partial class datalayerAdded1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vivastreet_Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vivastreet_Models.Condition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vivastreet_Models.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vivastreet_Models.SelectAge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vivastreet_Models.ServiceOffered", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vivastreet_Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Vivastreet_Models.Advertisement", b =>
                {
                    b.HasOne("Vivastreet_Models.Category", "Category")
                        .WithMany()
                    ...
                    b.HasOne("Vivastreet_Models.Material", "Material")
                        .WithMany()
                        .HasForeignKey("MaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vivastreet_Models.SelectAge", "SelectAge")
                        .WithMany()
